...
p0 = 'D:\2photon\AB23\191109_FOV1\Projections\Green\'; %% tif folder

%% For cell boundary and landmark
p_cell = 'D:\2photon\AB23\191109_FOV1\AB23_191109_FOV1_Cell.mat';   % cell boundary path, if you have
p_landmark = 'D:\2photon\AB23\191109_FOV1\AB23_191109_FOV1_Soma.mat';   % landmark path, if you have
...
[opts,optsInfo,optsName,cfg] = util.parseParam();


opts = util.parseParam_for_batch(x,0,'D:\2photon\AB23\191109_FOV1\Projections\AB23_191109_FOV1_greenProj_cat_Opt.csv');
%% 
